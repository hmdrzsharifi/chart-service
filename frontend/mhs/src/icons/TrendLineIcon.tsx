...
const TrendLineIcon = (props: {selected: boolean, color: string}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" stroke={props.color} strokeWidth={props.selected ? '1' : '0'}>
