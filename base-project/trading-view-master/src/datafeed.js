...
function mapSymbolResult(originalObject) {
    return {
        ...
        exchange: originalObject.categoryName,
        type: originalObject.categoryName,
    };
}
...
async function getAllSymbols() {
    ...
    try {
		...
		// resultData.forEach(symbol => {
        //     const type = configurationData.symbols_types[symbol.categoryName];
        //     if (!categorizedSymbols[type]) {
        //         categorizedSymbols[type] = [];
        //     }
        //     categorizedSymbols[type].push(symbol);
        // });
        //
        // console.log({categorizedSymbols})
...
export default {
    ...
    resolveSymbol: async (symbolName, onSymbolResolvedCallback, onResolveErrorCallback, extension) => {
        ...
        var name = symbolName.replace('_USD', 'USDT');
    ...
    getBars: async (symbolInfo, resolution, periodParams, onHistoryCallback, onErrorCallback) => {
        ...
        const requestBody = {
            "Ticker": symbolInfo.ticker, "TimeFrame": reqResolution, "from": from, "to": to
        };
        const resultData = [];
        try {
    ...
    subscribeBars: (symbolInfo, resolution, onRealtimeCallback, subscriberUID, onResetCacheNeededCallback,) => {
        ...
        subscribeOnStream(symbolInfo, resolution, onRealtimeCallback, subscriberUID, onResetCacheNeededCallback, lastBarsCache.get('BINANCE:BTCUSDT'),);
    },
